...
export const ASYNC_INCREMENT_COUNTER = 'counter/ASYNC_INCREMENT_COUNTER';
export const ASYNC_DECREMENT_COUNTER = 'counter/ASYNC_DECREMENT_COUNTER';
export const UPDATE_VALUE = 'shared/MUTATE_UPDATE_VALUE';
